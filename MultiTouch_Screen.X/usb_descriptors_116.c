...
ROM struct{BYTE report[HID_RPT01_SIZE];}hid_rpt01={{
    ...
    0x26, 0x80, 0x07,           //       LOGICAL_MAXIMUM (0x780=1920)        // Screen width
    0x75, 0x10,           //       REPORT_SIZE (16)
    0x55, 0x0E,           //       UNIT_EXPONENT (-2)           //10^(-2)
    0x65, 0x33,           //       UNIT (Inches, English Linear)
    0x09, 0x30,           //       USAGE (X)
    0x35, 0x00,           //       PHYSICAL_MINIMUM (0)
    0x46, 0xF6, 0x03,           //       PHYSICAL_MAXIMUM (0x3F6 = 1014)     //1014 * 10^(-2) = 10.14 inches X-dimension
    ...
    0x26, 0x38, 0x04,           //       LOGICAL_MAXIMUM (0x438=1080)        // Screen height
    0x46, 0x3C, 0x02,           //       PHYSICAL_MAXIMUM (0x23C = 572)    //572 * 10^(-2) = 5.72 inches Y-dimension
    0x09, 0x31,           //       USAGE (Y)
